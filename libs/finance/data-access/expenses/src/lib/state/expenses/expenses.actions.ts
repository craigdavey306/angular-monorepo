...
export const fetchExpensesSuccess = createAction(
  `[Expenses] Fetch Expenses Success`,
  props<{ expenses: ExpenseModel[] }>()
);
export const fetchExpensesFailed = createAction(
  `[Expenses] Fetch Expenses Failed`
);
...
export const deleteExpenseFailed = createAction(
  `[Expenses] Delete Expenses Failed`
);
...
export const selectExpenseSuccess = createAction(
  `[Expenses] Select Expenses Success`,
  props<{ expense: ExpenseModel }>()
);
export const selectExpenseFailed = createAction(
  `[Expenses] Fetch Expense Failed`
);
...
export const updateExpenseSuccess = createAction(
  `[Expenses] Update Expenses Success`,
  props<{ expense: ExpenseModel }>()
);
export const updateExpenseFailed = createAction(
  `[Expenses] Update Expenses Failed`
);
